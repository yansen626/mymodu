                ...
                <div>
                    ...
                    <div class="row">
                        <div class="column width-2">
                            <img src="{{ URL::asset('images/product/gripper-product.jpg') }}"/>
                        </div>
                        ...
                        <div class="column width-2">
                            <img src="{{ URL::asset('images/product/upender.png') }}"/>
                        </div>
                        <div class="column width-10">
                        ...
                        <div class="column width-2">
                            <img src="{{ URL::asset('images/product/De-Puck.png') }}"/>
                        </div>
                        <div class="column width-10">
                        ...
                        <div class="column width-2">
                            <img src="{{ URL::asset('images/product/c-type with infeed.png') }}"/>
                        </div>
                        <div class="column width-10">
                        ...
                        <div class="column width-2">
                            <img src="{{ URL::asset('images/product/cross over - 1.png') }}"/>
                        </div>
                        <div class="column width-10">
                        ...
                        <div class="column width-2">
                            <img src="{{ URL::asset('images/product/inverter air riser.png') }}"/>
                        </div>
                        <div class="column width-10">
                    ...
                    <a href="/download/Gripper System.pdf" class="button medium rounded bkg-theme bkg-hover-theme color-white color-hover-white">Gripper Conveyors</a>
                </div>
            </div>
        </div>
    </div>
