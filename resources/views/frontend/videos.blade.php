    ...
    <div class="section-block pb-0 bkg-white">
        <div class="row flex">
            ...
            <div class="column width-6">
                <div>
                    <h4>MODU Accumulation Conveyor</h4>
                    <div class="video-container">
                        <iframe width="500" height="281" src="https://www.youtube.com/embed/PFwBWc0ledo" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="column width-6">
            ...
            <div class="column width-6">
                <div>
                    <h4>MODU Laner / Diverter (From 1 to 4 Lanes)</h4>
                    <div class="video-container">
                        <iframe width="500" height="281" src="https://www.youtube.com/embed/C50Q0Iu7f7Q" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="column width-6">
            ...
            <div class="column width-6">
                <div>
                    <h4>MODU Stainless Steel Conveyor with Thermoplastic Chain</h4>
                    <div class="video-container">
                        <iframe width="500" height="281" src="https://www.youtube.com/embed/FOvkSTdusbY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
