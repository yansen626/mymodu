				...
				<div class="column width-8 push-2">
					<div class="hero-content split-hero-content">
						<div class="hero-content-inner left horizon" data-animate-in="preset:slideInRightShort;duration:1000ms;delay:200ms;" data-threshold="0.5">
							<p class="lead color-white">Started Industrial Conveyor & Automation </p>
				...
				<div class="column width-9 offset-1">
					...
					<div class="row flex">
						<div class="column width-6">
							...
							<img src="{{ URL::asset('images/about-us/innovation1.jpg') }}" alt=""/>
						...
						<div class="column width-6">
							...
							<img src="{{ URL::asset('images/about-us/ISO.jpg') }}" alt=""/>
						...
						<div class="column width-6">
							...
							<img src="{{ URL::asset('images/about-us/environment1.jpg') }}" alt=""/>
